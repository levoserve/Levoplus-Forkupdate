...
{
    resize(850, 550);
    setWindowTitle(tr("Levopluscoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Levopluscoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Levopluscoin"), this);
    aboutAction->setStatusTip(tr("Show information about Levopluscoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Levopluscoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Levopluscoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Levopluscoin addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your Levopluscoin addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Levopluscoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Levopluscoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Levopluscoin network", "", count));
}
...
{
    QString strTitle = tr("Levopluscoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Levopluscoin address or malformed URI parameters."));
    }
