...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LVPS");
    case mBTC: return QString("mLVPS");
    case uBTC: return QString::fromUtf8("μLVPS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Levopluscoins"));
    case mBTC: return QString(QObject::tr("Milli-Levopluscoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Levopluscoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
